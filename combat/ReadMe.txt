========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet combat
========================================================================

AppWizard a cr&eacute;&eacute; cette application combat pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application combat.
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; combat.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
